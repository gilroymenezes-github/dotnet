...
using TravelSample.Models.GraphQL;
...
namespace TravelSample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<AirportObjectGraph>();
            services.AddScoped<AirportObjectGraphQuery>();
            services.AddScoped<AirportSchema>();
            services.AddScoped<IDependencyResolver>(s => new FuncDependencyResolver(type => s.GetRequiredService(type)));
            

            services.AddGraphQL(o => { o.ExposeExceptions = false; }) //false for prod
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseGraphiQLServer(new GraphiQLOptions() { GraphiQLPath = "/ui/graphiql", GraphQLEndPoint = "/graphql" });
