...
{
    public class SalesOrdersService : BackgroundService
    {
        private readonly ILogger<SalesOrdersService> logger;
        private ServiceBusProcessor busProc;
        private SalesOrdersQueueClient sbClient;
        private SalesOrdersRepository dbRepository;

        public SalesOrdersService(ILogger<SalesOrdersService> logger, 
            SalesOrdersQueueClient sbClient, 
            SalesOrdersRepository dbRepository)
        {
            this.logger = logger;
        ...
        async Task MessageHandler(ProcessMessageEventArgs args)
        {
            ...
            var itemCmd = System.Text.Json.JsonSerializer.Deserialize<SalesOrderCommand>(body);
