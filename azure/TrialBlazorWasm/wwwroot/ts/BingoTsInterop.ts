...
function AddPushpin(sitePin: BingPin): void {
    let pushPin = new Microsoft.Maps.Pushpin(sitePin.location, {
        ...
        anchor: new Microsoft.Maps.Point(sitePin.location.latitude, sitePin.location.longitude),
        color: sitePin.color
    });
