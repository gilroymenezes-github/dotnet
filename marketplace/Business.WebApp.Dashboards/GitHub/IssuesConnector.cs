...
using Business.WebApp.Dashboards.GitHub.Models;

namespace Business.WebApp.Dashboards.GitHub
{
    class Link
    {
    ...
    public class GitHubService
    {
        ...
        public GitHubService(IHostEnvironment hostEnvironment)
        {
        ...
        public async Task<IEnumerable<Issue>> GetIssues(DateTime date)
        {
            ...
            var cacheFile = Path.Combine(webRootPath, "issues.json");
