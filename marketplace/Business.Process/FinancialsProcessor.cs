...
{
    public class FinancialsProcessor : BackgroundService
    {
        private readonly ILogger<FinancialsProcessor> logger;
        private ServiceBusProcessor busProc;
        private FinancialsQueueClient sbClient;
        private FinancialsRepository dbRepository;

        public FinancialsProcessor(ILogger<FinancialsProcessor> logger, FinancialsQueueClient sbClient, FinancialsRepository dbRepository)
        {
            this.logger = logger;
