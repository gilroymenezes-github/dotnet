...
{
    public abstract class BaseClient<T> where T: BaseModel
    {
        protected HttpClient HttpClient;
        protected JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { PropertyNameCaseInsensitive = true };
        protected ILogger<BaseClient<T>> Logger;
        protected string ResourceName;
        
        protected BaseClient(HttpClient httpClient, ILogger<BaseClient<T>> logger)
        {
